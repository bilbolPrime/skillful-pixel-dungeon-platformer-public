...
public class Confuse extends ActiveSkill {

    {
        manaCost = 5;
    }

    public Confuse(int id, HeroClass skillClass, int tier, String name, String quickDescription, String description, String sprite) {
    ...
    public void use(Unit owner, Unit target){
        ...
        ConfuseProjectile fireBolt = new ConfuseProjectile();
