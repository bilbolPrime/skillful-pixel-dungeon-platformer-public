...
public class DescriptionWindow extends Window{
    ...
    public Window build(){
        ...
        float maxTextHeight = Math.max(60f, maxOverlayHeight - 200f - reservedBottomHeight);
        ...
        height = Math.min(maxOverlayHeight, Math.max(height, fittedDescription.height + 200f + reservedBottomHeight));
        super.build();
