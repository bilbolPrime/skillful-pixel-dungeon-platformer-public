...
public class Slow extends ActiveSkill {

    {
        manaCost = 5;
    }

    public Slow(int id, HeroClass skillClass, int tier, String name, String quickDescription, String description, String sprite) {
    ...
    public void use(Unit owner, Unit target){
        ...
        SlowProjectile fireBolt = new SlowProjectile();
