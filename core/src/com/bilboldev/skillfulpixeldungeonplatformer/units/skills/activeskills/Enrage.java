...
import com.bilboldev.skillfulpixeldungeonplatformer.units.projectiles.buffprojectiles.BlindProjectile;
import com.bilboldev.skillfulpixeldungeonplatformer.units.projectiles.buffprojectiles.EnrageProjectile;

public class Enrage extends ActiveSkill {

    {
        manaCost = 5;
    }

    public Enrage(int id, HeroClass skillClass, int tier, String name, String quickDescription, String description, String sprite) {
    ...
    public void use(Unit owner, Unit target){
        ...
        EnrageProjectile fireBolt = new EnrageProjectile();
