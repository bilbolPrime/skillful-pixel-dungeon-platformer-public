...
public class Weaken extends ActiveSkill {

    {
        manaCost = 5;
    }

    public Weaken(int id, HeroClass skillClass, int tier, String name, String quickDescription, String description, String sprite) {
    ...
    public void use(Unit owner, Unit target){
        ...
        WeakenProjectile fireBolt = new WeakenProjectile();
