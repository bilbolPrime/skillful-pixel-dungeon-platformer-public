...
import com.bilboldev.skillfulpixeldungeonplatformer.units.projectiles.buffprojectiles.DominateProjectile;
import com.bilboldev.skillfulpixeldungeonplatformer.units.projectiles.buffprojectiles.EnrageProjectile;

public class Dominate extends ActiveSkill {

    {
        manaCost = 25;
    }

    public Dominate(int id, HeroClass skillClass, int tier, String name, String quickDescription, String description, String sprite) {
    ...
    public void use(Unit owner, Unit target){
        ...
        DominateProjectile fireBolt = new DominateProjectile();
