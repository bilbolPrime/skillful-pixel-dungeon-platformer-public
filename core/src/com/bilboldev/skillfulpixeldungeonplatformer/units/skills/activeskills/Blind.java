...
public class Blind extends ActiveSkill {

    {
        manaCost = 5;
    }

    public Blind(int id, HeroClass skillClass, int tier, String name, String quickDescription, String description, String sprite) {
    ...
    public void use(Unit owner, Unit target){
        ...
        BlindProjectile fireBolt = new BlindProjectile();
