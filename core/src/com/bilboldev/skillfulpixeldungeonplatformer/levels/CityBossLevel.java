...
import com.bilboldev.skillfulpixeldungeonplatformer.levels.rooms.KingRoom;
...
public class CityBossLevel extends CityLevel {
    {
        units = new HashMap<>();
        perRoom = 0;
    }
    ...
    public Level generateLevel(int depth) {
        ...
        Room room = new KingRoom(identifier).build();
        addRoom(room);
